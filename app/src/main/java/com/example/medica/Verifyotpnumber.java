...
public class Verifyotpnumber extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.verifyotpnumber);
        ...
        buttonVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (inputCode1.getText().toString().trim().isEmpty()||inputCode2.getText().toString().trim().isEmpty()||
                    ...
                    Toast.makeText(Verifyotpnumber.this,"Invalid Code",Toast.LENGTH_SHORT).show();
                    return;
                }
                String code=
                            ...
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (task.isSuccessful()){
                                        ...
                                        Toast.makeText(Verifyotpnumber.this,"Invalid Verification Code",Toast.LENGTH_SHORT).show();
                ...
                PhoneAuthProvider.getInstance().verifyPhoneNumber("" +
                        ...
                        new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                ...
                                Toast.makeText(Verifyotpnumber.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                            ...
                            public void onCodeSent(@NonNull String newVerificationId, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                ...
                                Toast.makeText(Verifyotpnumber.this,"Verification Code sent",Toast.LENGTH_SHORT).show();
