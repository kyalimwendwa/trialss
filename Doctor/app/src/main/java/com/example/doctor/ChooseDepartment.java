...
public class ChooseDepartment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doctorAdapter=new DoctorAdapter(ChooseDepartment.this,doctorMdlList);
        ...
        cardiology.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ChooseDepartment.this,CardiologyDentalAppointment.class));
            }
        });
        dental.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ChooseDepartment.this,BookAppointment.class));
            }
        });
        consultation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ChooseDepartment.this,ConsultationDoctorAppointment.class));
            }
        });
