...
public class DentalDoctorsAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dental_doctors_appointment);
        ...
        mRef=mDatabase.getReference().child("Dental Doctors");
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dexter.withActivity(DentalDoctorsAppointment.this)
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Task<Uri> downloadUrl=taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    Intent intent=new Intent(DentalDoctorsAppointment.this,RetrievedDoctorData.class);
