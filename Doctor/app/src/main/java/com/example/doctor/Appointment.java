...
public class Appointment extends AppCompatActivity {
    ...
    ImageView imageView;
    Button update;
    EditText fullname,department,time,time1,time2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update=findViewById(R.id.timebtn);

        mDatabase=FirebaseDatabase.getInstance();
        mRef=mDatabase.getReference().child("Updates");
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dexter.withActivity(Appointment.this)
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!(fn.isEmpty()&&dp.isEmpty()&&tm.isEmpty()&&tm1.isEmpty()&&tm2.isEmpty()&&datee.isEmpty()&&imageUrl!=null))
                {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Task<Uri> downloadUrl=taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    newpost.child("Time").setValue(tm);
                                    ...
                                    Intent intent=new Intent(Appointment.this,RetrievedDoctorData.class);
