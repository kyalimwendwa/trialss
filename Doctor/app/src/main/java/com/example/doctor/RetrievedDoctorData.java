...
public class RetrievedDoctorData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrieved_doctor_data);
        ...
        doctorAdapter=new DoctorAdapter(RetrievedDoctorData.this,doctorMdlList);
        ...
        doclogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(RetrievedDoctorData.this,DoctorUseOnly.class));
            }
        });
        cardiology.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RetrievedDoctorData.this,Cardiology.class));
            }
        });
        dental.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RetrievedDoctorData.this,Dental.class));
            }
        });
        consultation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RetrievedDoctorData.this,GeneralTreatment.class));
            }
        });
